% Script: Figure_S3
% 
% This script plots Supplementary Figure S3, which shows the number of
% negative correlations in the data of Figure 5 as a function of
% different parameters (a1, a2, a3, mu_Q0, mu_W) that together describe the
% rules of life of each species. A negatvie correlation means that the
% trade-off has been unmasked. The script accesses the output from the script 
% 'categorize', called 'categories.mat'.
