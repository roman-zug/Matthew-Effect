% Script: Figure_S9
% 
% This script plots Supplementary Figure S9, which shows the distribution 
...
% age dependence, which means that production of sexual eggs does not start 
% above sexual threshold y (there is no such threshold in the model version 
% with age dependence), but rather after a given time point called 't_sexual'.
...
% correlation. The script accesses the output from the script 
% 'categorize_with_age_dependence', called 'categories_with_age_dependence.mat'.


clear;
addpath('../functions'); % Add the "functions" folder to the search path
load categories_with_age_dependence.mat
