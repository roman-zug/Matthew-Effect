% Script: Figure_S7
% 
% Purpose: This script plots Supplementary Figure S7, which shows queen lifespan and
% different measures of queen fecundity as a function of x, with age dependence, 
