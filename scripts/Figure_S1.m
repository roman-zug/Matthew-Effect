...
% workforce size (c, d). The script accesses and merges two figures called
% 'Figure_Temporal_Dynamics_Lucky_Queen.fig' and
% 'Figure_Temporal_Dynamics_Unlucky_Queen.fig'.
