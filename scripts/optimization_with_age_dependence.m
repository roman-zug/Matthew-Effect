% Script: optimization_with_age_dependence
% 
% This script accesses the output from 'collate_fitness_with_age_dependence' 
% called 'collated_with_age_dependence.mat' to find the optimal x* values for 
% the 50 different parameter sets, using spline fitting, with age dependence, 
...
% age dependence), but rather after a given time point called 't_sexual'. 
% Output is saved as 'optimal_values_with_age_dependence.mat', which is 
% accessed by the script 'categorize_with_age_dependence'. 
% 'optimization_with_age_dependence' is an auxiliary script to plot 
...
save('optimal_values_with_age_dependence.mat', 'optimal_x_all');
