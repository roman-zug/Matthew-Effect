% Script: Figure_S5
% 
% Purpose: This script plots Supplementary Figure S5, which shows an example
% of the ltemporal dynamics of a colony life cycle with age dependence, which
...
[lifespan, total_eggs, total_sexuals, rate_eggs, rate_sexuals, t_series, eggs_series, sexuals_series, workforce_series] = matthew_with_age_dependence(params, x, t_sexual);
