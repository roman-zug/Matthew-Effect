% Script: maketask_with_age_dependence
% 
% Purpose: This script generates a dataset called 'task_with_age_dependence.mat' 
% that contains 50 sets of random parameter combinations (a1, a2, a3, mu_q0,
% mu_w), corresponsing to 50 hypothetical species, with age dependence, which 
...
% rather after a given time point called 't_sexual'. 'task_with_age_dependence.mat' 
% is accessed by the script 'runtask_with_age_dependence'. 'maketask_with_age_dependence' 
