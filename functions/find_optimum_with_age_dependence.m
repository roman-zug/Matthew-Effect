% Function: find_optimum_with_age_dependence
%
% Purpose: This function finds the optimal x value using cubic smoothing
% spline (csaps), with age dependence, which means that production of sexual eggs 
...
% called 't_sexual'. 'find_optimum_with_age_dependence' is used in the script
% 'Figure_S8'.
%
% Inputs:
...
function [xopt, max_value, iopt] = find_optimum_with_age_dependence(TSmean, x)
