% Function: matthew_with_age_dependence
% 
% Purpose: This function runs the main algorithm with age dependence, which 
...
function [lifespan, total_eggs, total_sexuals, rate_eggs, rate_sexuals, t_series, eggs_series, sexuals_series, workforce_series] = matthew_with_age_dependence(params, x, t_sexual)

nofcolonies = length(x);

if nargout > 5 && nofcolonies > 1
    disp('Warning: the time series do not work for multiple colonies at a time');
    pause;
end
